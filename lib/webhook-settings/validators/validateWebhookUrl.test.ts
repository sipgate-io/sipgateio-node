...
describe('ValidateWebhookUrl', () => {
	test.each`
		...
		${'httptest://'}       | ${{ isValid: false, cause: ValidatorMessages.INVALID_WEBHOOK_URL }}
		${''}                  | ${{ isValid: false, cause: ValidatorMessages.INVALID_WEBHOOK_URL }}
		${'httpsx'}            | ${{ isValid: false, cause: ValidatorMessages.INVALID_WEBHOOK_URL }}
		${'://'}               | ${{ isValid: false, cause: ValidatorMessages.INVALID_WEBHOOK_URL }}
		${'www.url.com'}       | ${{ isValid: false, cause: ValidatorMessages.INVALID_WEBHOOK_URL }}
	`(
