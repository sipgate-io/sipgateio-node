...
describe('ClickToDial validation', () => {
	test.each`
		input                                                                                        | expected
		${{ callee: '01573977777', caller: '+49++', callerId: null, deviceId: null }}                | ${{ isValid: false, cause: 'caller is not a valid extension nor phone number' as ErrorMessage }}
		${{ callee: '01573977777', caller: '+49++', callerId: null, deviceId: 'g5' }}                | ${{ isValid: false, cause: 'caller is not a valid extension nor phone number' as ErrorMessage }}
		${{ callee: '01573977777', caller: '+49++', callerId: null, deviceId: 'p0' }}                | ${{ isValid: false, cause: 'caller is not a valid extension nor phone number' as ErrorMessage }}
		${{ callee: '01573977777', caller: '+49++', callerId: '+49++', deviceId: null }}             | ${{ isValid: false, cause: 'caller is not a valid extension nor phone number' as ErrorMessage }}
		${{ callee: '01573977777', caller: '+49++', callerId: '+49++', deviceId: 'g5' }}             | ${{ isValid: false, cause: 'caller is not a valid extension nor phone number' as ErrorMessage }}
		${{ callee: '01573977777', caller: '+49++', callerId: '+49++', deviceId: 'p0' }}             | ${{ isValid: false, cause: 'caller is not a valid extension nor phone number' as ErrorMessage }}
		${{ callee: '01573977777', caller: '+49++', callerId: '01573977777', deviceId: null }}       | ${{ isValid: false, cause: 'caller is not a valid extension nor phone number' as ErrorMessage }}
		${{ callee: '01573977777', caller: '+49++', callerId: '01573977777', deviceId: 'g5' }}       | ${{ isValid: false, cause: 'caller is not a valid extension nor phone number' as ErrorMessage }}
		${{ callee: '01573977777', caller: '+49++', callerId: '01573977777', deviceId: 'p0' }}       | ${{ isValid: false, cause: 'caller is not a valid extension nor phone number' as ErrorMessage }}
		${{ callee: '01573977777', caller: '01573977777', callerId: null, deviceId: null }}          | ${{ isValid: false, cause: 'deviceId is mandatory if caller is not a extension' as ErrorMessage }}
		...
		${{ callee: '01573977777', caller: '01573977777', callerId: '+49++', deviceId: null }}       | ${{ isValid: false, cause: 'deviceId is mandatory if caller is not a extension' as ErrorMessage }}
		...
		${{ callee: '01573977777', caller: '01573977777', callerId: '+49++', deviceId: 'p0' }}       | ${{ isValid: false, cause: 'Invalid callerId' as ErrorMessage }}
		${{ callee: '01573977777', caller: '01573977777', callerId: '01573977777', deviceId: null }} | ${{ isValid: false, cause: 'deviceId is mandatory if caller is not a extension' as ErrorMessage }}
		...
		${{ callee: '01573977777', caller: 'e25', callerId: '+49++', deviceId: null }}               | ${{ isValid: false, cause: 'Invalid callerId' as ErrorMessage }}
		${{ callee: '01573977777', caller: 'e25', callerId: '+49++', deviceId: 'g5' }}               | ${{ isValid: false, cause: ErrorMessage.VALIDATOR_INVALID_EXTENSION }}
		${{ callee: '01573977777', caller: 'e25', callerId: '+49++', deviceId: 'p0' }}               | ${{ isValid: false, cause: 'Invalid callerId' as ErrorMessage }}
